...
type LogoVariant = 'nav' | 'hero' | 'cta' | 'footer' | 'sidebar';
  ...
  if (variant === 'sidebar') {
    return (
      <svg width="180" height="50" viewBox="0 0 180 50" fill="none" aria-label="ClaimDrift" role="img">
        <defs>
          <linearGradient id="waveSidebarGrad" x1="0" y1="0" x2="1" y2="0">
        ...
        <text x="0" y="18" fontFamily="Syne, sans-serif" fontSize="18" fontWeight="800" fill="#F5C518" letterSpacing="0.04em">CLAIM</text>
        <text x="0" y="38" fontFamily="Syne, sans-serif" fontSize="18" fontWeight="800" fill="#FFFFFF" letterSpacing="0.04em">DRIFT</text>
        <polyline points="96,24 106,24 113,14 120,24 127,24 135,30 143,24 170,24 180,24"
          fill="none" stroke="url(#waveSidebarGrad)" strokeWidth="1.2" strokeLinejoin="round"/>
        <circle cx="135" cy="30" r="5"   fill="none" stroke="#F5C518" strokeWidth="1"/>
        <circle cx="135" cy="30" r="1.4" fill="#F5C518"/>
        <line x1="135" y1="22" x2="135" y2="25" stroke="#F5C518" strokeWidth="0.9"/>
        <line x1="135" y1="35" x2="135" y2="38" stroke="#F5C518" strokeWidth="0.9"/>
        <line x1="127" y1="30" x2="130" y2="30" stroke="#F5C518" strokeWidth="0.9"/>
        <line x1="140" y1="30" x2="143" y2="30" stroke="#F5C518" strokeWidth="0.9"/>
      </svg>
    );
  }
